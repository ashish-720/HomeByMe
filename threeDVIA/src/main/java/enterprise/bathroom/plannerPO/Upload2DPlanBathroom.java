...
import kitchen.bryo.pageObject.Upload2DPlan;
...
public class Upload2DPlanBathroom {
    WebDriver driver;

    public Upload2DPlanBathroom (WebDriver driver) {this.driver=driver;}
    ...
    @FindBy(xpath = "//button[@id='pdf-next']")
    private WebElement nextBtn;

    @FindBy(xpath = "//button[@id='pdf-prev']")
    private WebElement prevBtn;


    public Upload2DPlanBathroom getStarted(){
        ...
        Verification.displayNAttributeCheckOfElement(floorplanImage, "image", "src",
                "https://preprod-bathroom.enterprise-dev.by.me/Bathroom/assets/images/import-2d-plan/import-2d-plan-onboarding.png");
    ...
    public Upload2DPlanBathroom selectFile(String fileName) {
        ...
        selectFile.sendKeys(new File(Setting.bathroomImg + fileName).getAbsolutePath());
        return PageFactory.initElements(driver, Upload2DPlanBathroom.class);
    }

    public Upload2DPlanBathroom zoomIn(int zoomIncount) {
    ...
    public Upload2DPlanBathroom zoomOut(int zoomOutcount) {
    ...
    public Upload2DPlanBathroom chooseThisPage() {
        ...
        public Upload2DPlanBathroom selectFloorPlan(int xOffset, int yOffset) {
            Actions action = new Actions(driver);
            action.moveToElement(container3D, xOffset, yOffset).clickAndHold().pause(500).release().build().perform();
            return PageFactory.initElements(driver, Upload2DPlanBathroom.class);
        }

        public Upload2DPlanBathroom yourPlan() {
    ...
    public Upload2DPlanBathroom deleteYourPlan() {
    ...
    public Upload2DPlanBathroom deleteNo() {
    ...
    public Upload2DPlanBathroom changeYourPlan() {
        changeYourPlan.click();
        UtilHBM.waitExplicitDisplayed(driver, selectFile);
        return PageFactory.initElements(driver, Upload2DPlanBathroom.class);
    }

    public Upload2DPlanBathroom undo(WebDriver driver, int number) {
    ...
    public Upload2DPlanBathroom redo(WebDriver driver, int number) {
        for (int i = 0; i < number; i++) {
            redoButton.click();
    ...
    public Upload2DPlanBathroom deleteYes() {
    ...
    public Upload2DPlanBathroom rotation(int xOffset, int yOffset, String angle) {
    ...
    public Upload2DPlanBathroom movePlanBathroom(int x, int y, int x1, int y1) {
    ...
    public Upload2DPlanBathroom opacity(int xOffset, int yOffset, String value) {
        UtilHBM.waitFixTime(500);
    ...
    public Upload2DPlanBathroom nextBtn(int nxtCount) {
        for (int i = 1; i <= nxtCount; i++) {
            nextBtn.click();
        }
        return this;
    }

    public Upload2DPlanBathroom prevBtn(int prevCount){
    ...
    public Upload2DPlanBathroom move() {
        UtilHBM.waitFixTime(500);
