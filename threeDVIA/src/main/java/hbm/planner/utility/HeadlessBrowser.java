...
public class HeadlessBrowser {
	...
	public void openBrowser(@Optional("chrome")String browser, @Optional("prod") String link){		
		if (browser.equalsIgnoreCase("FF")){			
			//System.setProperty("webdriver.gecko.driver", "./src/main/GeckoDriver/geckodriver");
...
//		        firefoxBinary.setEnvironmentProperty("DISPLAY", Xport); Commented for Selenium version 3.141.59

			//ProfilesIni profile = new ProfilesIni();
			//FirefoxProfile myprofile = profile.getProfile("AutoTest");				
	
//		driver = new FirefoxDriver(firefoxBinary, null); commented after updating selenium 3.4 to 3.9.1
