...
public class FreeStandingWorktop extends Browser {
    ...
    public void freeStandingWorktopTest() {
		...
		.startFromScratch()
                .step3()
                .addProductThroughSearch("Worktop", "LAMINATE DOUBLE WHITE", true, false)
                ...
                .undo(5)
                .replaceFreeStandingProperty(10,20, "LAMINATE DOUBLE WHITE", "ACRYLIC WHITE", "", true, "ACRYLIC WHITE")
...
//		.validateWorktopEditor();
                ...
                .cancelWorktopEditor()
                .twoDView().emptyRoom(64, -141, "KITCHEN", "16.0 m²", "Yes").threeDView()
                .verifyPrice("0,00")
...
//                .verifyReducedOrMemberPrice("member", "1 438,55")
                ...
                .twoDView().emptyRoom(65, -141, "KITCHEN", "16.0 m²", "Yes").threeDView()
                ...
                .replaceFreeStandingProperty(0, 140, "illustration worktop", "ACRYLIC WHITE", "selection", true, "ACRYLIC WHITE")
