...
public class SaveScenarioForStep3IslandKitchen extends Browser {
    @Test(dataProvider = "bryoLogin", dataProviderClass = SignUpData.class)
    public void saveScenarioForIslandKitchen(SignUpData signUpData) {
		...
		.startFromScratch()
                ...
                .twoDView()
                .threeDView()
                .saveProjectInStep3(signUpData, "SAVE_ODT_IN_STEP_3_" + UtilHBM.getDate(0, "yyyyMMdd"), "MY BRYO KITCHEN created on" + UtilHBM.getDate(0, "yyyyMMdd"))
                .closePlanner()
                .logout();
    }
