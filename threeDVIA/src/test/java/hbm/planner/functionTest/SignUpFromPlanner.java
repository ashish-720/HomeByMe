...
public class SignUpFromPlanner extends Browser{
	
	@Test(dataProvider="newUserSignUpData", dataProviderClass=SignUpData.class)
	public void signUpFromTrialProject(SignUpData signUpData){
		...
		.saveAsCopy("Sign Up From Trial Project")
		.save()
		.closePlanner()
		.logout()
		.loginExistingUser(signUpData)
		.goToMyProjects()
		.openOwnProject(0, "Sign Up From Trial Project")
